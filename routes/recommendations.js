...
router.get('/smart', protect, async (req, res) => {
  try {
    ...
    const userProfileSeeds = topSeeds.slice(0, 5); // Base profile on their 5 strongest anchors
    ...
    // ALGORITHM PHASE 2: Gather candidate topology pools natively via High Speed Base Arrays
